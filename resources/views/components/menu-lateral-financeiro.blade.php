...
<div id="sidebar"
    ...
    <ul class="p-4 space-y-4">
     ...
     <div class="absolute bottom-0 z-100 left-0 w-full p-4 mb-12  border-gray-200 text-center text-xs text-gray-400">
     &copy; 2024 - {{ date('Y') }} <a href="https://softetech.com.br" target="_blank" class="text-blue-600 hover:underline">SOFTETECH, EI.</a>Todos os direitos reservados.
</div>
